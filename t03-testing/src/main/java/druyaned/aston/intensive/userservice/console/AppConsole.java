...
/**
 * Invoker of and main director of the app. It holds command map and requests
 * input from an app user by {@code scanner}. Output of the command execution
 * goes to {@code out} stream. To start the interactive execution call
 * {@link #run()} method.
 *
 * @author druyaned
 */
